<template>
    <div class="c-control c-control-radio">
        ...
        >
            <label class="cursor-pointer duration-500 flex group hover:bg-slate-100 items-center px-2.5 py-1 relative rounded text-slate-700 text-sm transition-all w-auto" v-for="option in options">
